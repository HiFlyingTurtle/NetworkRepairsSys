	...
	$("#form").form("submit",{
		...
		success:function(result){
			if(result.errorMsg){
				...
				$.messager.alert("温馨提示","密码修改成功！您将重新登录...","info",function(){
...
<body style="margin: 5px">
	<table id="dg" title="密码维护" class="easyui-datagrid" fitColumns="true"
	  pagination="true" rownumbers="true" url="personInfoModify" toolbar="#tb" 
	  fit="true" nowrap="false" striped="true" singleselect="false">
		<thead>
			<tr>
	...
	<div id="tb" style="padding-top: 10px;padding-bottom: 10px;padding-left: 10px">
		<div title="您的位置">您的位置：导航菜单>>系统管理>>密码维护</div><hr><br>
		说明：
		<div>1、默认只是查看个人登录账户,密码等信息<br>
		2、请选择个人信息后在进行密码修改<br>
		3、个人密码修改时，密码是不可见的<br>
		4、修改密码成功后,将关闭浏览器。请重新登录</div><br>
		<div style="color: black">相关操作：</div>
		<div title="相关操作">
			<a title="修改" href="javascript:personPWDModifyDialog()" class="easyui-linkbutton" iconCls="icon-pwd" plain="">修改密码</a>
		</div>
	</div>
	<!-- 对话框，个人信息修改时弹出的对话框 -->
	<div id="dlg" class="easyui-dialog" style="width: 450px;height: 370px" closed="true" buttons="#dlg-button" title="操作对话框">
		<form method="post" id="form" name="form">
			<table align="center" style="margin-top: 50px">
				<tr>
					<td>当前账号：</td>
					<td>${currentUser.userName}</td>
					<td><font color="red">***您当前的登录账号***</font></td>
				</tr>
				<tr height="10px"></tr>
				<tr>
					<td >旧密码：</td>
					<td><input type="password" id="password" value="${currentUser.password}"/></td>
					<td><font color="red">***您当前的登录密码***</font></td>
				</tr>
				<tr height="10px"></tr>
				<tr>
					<td >输入旧密码：</td>
				...
				<tr>
					...
					<td><font color="red">***输入您的新密码***</font></td>
				</tr>
				<tr height="10px"></tr>
				<tr>
					<td >确认新密码：</td>
					<td><input type="password" id="passwordOK" name="passwordOK" class="easyui-validatebox" required="true" /></td>
					<td><font color="red">***再次输入新密码***</font></td>
				</tr>
			</table>
		</form>
	</div>
	...
	<div id="dlg-button">
		...
		<a href="javascript:personPWDSave()" class="easyui-linkbutton" iconCls="icon-ok">保存</a>
	</div>
</body>
</html>