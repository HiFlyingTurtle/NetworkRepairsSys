   ...
   <div region="north" style="height: 60px;  background: url(images/layout-browser-hd-bg.gif) #7f99be repeat-x center 50%;" class="header" >
		...
		<div style=" width:12%; float: right;">
			<div style="padding-top: 10px;padding-left: 10px;">
				...
				<font size="15" color="white" face="黑体">您好:${currentUser.userName}[${currentUser.level}]</font>
			</div>
    ...
    <!-- 布局	，中央 -->
    <div id="mainPanle" region="center" style="background-color: #F7F7F7; overflow-y:hidden">
